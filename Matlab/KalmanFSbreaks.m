...
%QUESTION 3. WHAT IS A LIKELIHOOD FUNCTION? WHY DOES IT MAKE SENSE TO
%MAXIMIZE A LIKELIHOOD? WHERE AT THIS CODE DOES IT APPEAR? 

%QUESTION 4. WHAT IS THE PURPOSE OF USING KALMAN FILTER? 

%QUESTION 5. WHY THERE ARE FORWARD RUN (KALMAN FILTER) AND BACKWARD RUN (SMOOTHER)?

%QUESTION 6. WHAT ARE PARAMETERS TO BE ESTIMATED?

%QUESTION 7. WHAT ARE THE TIME-VARYING COEFFICIENTS IN THE CODE?
...
%QUESTION 8. WHAT IS B=eye(length(beta))? WHAT DOES THIS ASSUMPTION MEAN FOR YOUR STATE EQUATION?
...
for i1=1:smplT
    ...
    %QUESTION 9. WHAT DOES "zt0t1", "zt1t1", "Szt0t1", "Szt1t1", 
    %"yt0t1", Syt0t1 CORRESPONDS TO OUR CLASS' NOTATION?
